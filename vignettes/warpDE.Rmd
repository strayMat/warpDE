...
The other dataset in the package `warpDEDataSet_example` contains exactly this `df` object, so you are not forced to re-do the whole `slinghshot` workflow. [*** SD: I don't see `warpDEDataSet_example' in the package.]

# 2 - Visualization

We plot the gene expression profile for the first gene of the dataset (CreER) againg cell pseudotime for each lineage. [*** SD: First gene according to what criterion?]
