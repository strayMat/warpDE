...
```{r}
df <- new("lineageDEDataSet", logCounts = log1p(counts), t = times, w = w)
```
...
```{r}
ranking <- dtw_rank(df)
save(df, ranking, file = "/home/matthieu//Documents/Berkeley/work_Berkeley/lineageDE/tests/test.data.RData")
