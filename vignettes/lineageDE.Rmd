...
We also created an visualization of the distribution of the distances used for ranking genes. We plot this as an Elbow curve, which point at a hard threshold for differentially expressed genes based on this distribution.
```{r}
elbow_curve(vgam.aic.ranking)
```
