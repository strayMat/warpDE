...
```{r,fig.height=4, fig.width=6, fig.align="center"}
gene <- rownames(df@counts)[sample(1:12781,1)]
reg_vgam(df, gene, legend.show = T)$pl
```
...
save(aic.ranking, pval.ranking, file = "~/Documents/Berkeley/work_Berkeley/Lineage_TE/rankings/vgam_ranking.aic.RDATA")
